---
title: Layers of Value and Wealth
author: mikesco3
layout: post
name: nycdh-jekyll
...
excerpt: Not all forms of wealth are financial, and not all losses can be recovered. A framework for thinking about value, priorities, and long-term tradeoffs.
keywords: value systems, wealth, priorities, decision making, life balance, tradeoffs, relationships, purpose, systems thinking, personal development, meaningful work, philosophy, stewardship, moderation, cognitive model, leadership, common sense
description: An exploration of how different forms of wealth and value interact, why some tradeoffs cannot be reversed, and how to orient life around what matters most.
pin: true
---
___
...
A marriage remaining healthy over decades.
A strong community of friends and supporters.
...
Money can create time.
Time can strengthen relationships.
Knowledge can create financial opportunities.
Health can improve intellectual and emotional capacity.
...
To which the old man replied: _Yes, that could be true, however the main lesson is this:_
> **If the large stones are not placed first, they may never fit later.**
{: .prompt-warning }

I think life works similarly.
> Many people spend years filling their lives with sand and gravel, only to realize it too late, that they were missing the larger stones in the jar.
> The larger stone being our relationship with God, then loved ones, etc. 
> Finally the gravel and sand: Money, distractions, etc.
{: .prompt-tip }
...
This is one of the strangest aspects of life:
we often receive feedback long after decisions become difficult to reverse.
...
Habits solidify.
Priorities become embedded through repetition more than intention.
